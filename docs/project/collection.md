...
Apart from the common properties of [sound object](./sound-object.md) assets, a collection asset contains the following properties:
...
Provides the ID of a sound. That sound object should be defined as a [Sound](./sound.md) asset first. This value should be different from `0`.
